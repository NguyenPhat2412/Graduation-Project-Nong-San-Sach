    ...
    <div className="blog-details">
      ...
      <div className="blog-content">
        ...
        <ul>
          ...
          <li>
            <strong>Súp lơ:</strong> Theo các nghiên cứu, bông cải xanh hay súp
            lơ có chứa chất chống oxy hóa giúp bảo vệ tim và chống lại stress
            oxy hóa.
          </li>
          <li>
          ...
          <li>
            <strong>Bơ:</strong> Được xếp vào hàng siêu thực phẩm, bơ chứa nhiều
            chất béo lành mạnh cũng như vitamin và khoáng chất.
          </li>
        </ul>
